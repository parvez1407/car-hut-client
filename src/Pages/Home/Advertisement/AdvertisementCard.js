...
const AdvertisementCard = ({ promotion }) => {
    return (
        ...
        <>
            {!promotion.paid &&
                <div className="w-full dark:bg-gray-500 my-12 rounded-md" style={{ backgroundImage: `url(${promotion?.productImg})`, backgroundPosition: 'center', backgroundBlendMode: 'multiply', backgroundZize: 'cover', }}>
